        ...
        <div class="navTmenu container" id="navT-menu">
            ...
            <div class="navTdata">
                ...
                <ul class="navTlist">
                    ...
                    <li class="navTitem">
                        <a href="packageView.jsp" class="navTlink active-link">
               ...
               <div class="navTsignin " id="navT-signin">
                <a href="login.jsp">
                    ...
                    <button >LOG IN<i class='bx bxs-log-out-circle' ></i></button></a>
                </div>
    ...
    <main class="mainT" id="mainT">
        ...
        <section class="sectionT container " id="home">
            <div class="swiper mySwiper1">
                ...
                <div class="swiper-slide"><img src="image/indeximg/event1.jpg" alt="img1">
                <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="image/indeximg/event2.jpg" alt="img2">
                    <div class="inputone" >
                        <h1>Socials</h1>
                        <p>
                ...
                <div class="swiper-slide"><img src="image/indeximg/event3.jpg" alt="img3">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="image/indeximg/event4.jpg" alt="img4">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="image/indeximg/event5.jpg" alt="img5">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="image/indeximg/event7.jpg" alt="img7">
                    <div class="inputone" >
        ...
        <section class="sectionT container sectionTheight" id="packages">
            ...
            <div class="swiper mySwiper2">
                ...
                <div class="inputone1" ><img src="image/indeximg/event4.jpg" alt="img4">
        ...
        <section class="sectionT container sectionTheight" id="gallery">
            ...
            <div class="swiper mySwiper3">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                    <img src="image/indeximg/event5.jpg" alt="img5">
                </div>
                <div class="swiper-slide">
                    <img src="image/indeximg/event5.jpg" alt="img5">
                </div>
