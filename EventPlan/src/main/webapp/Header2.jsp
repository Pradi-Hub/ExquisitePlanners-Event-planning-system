...
<link rel="stylesheet" href="s_css/stylesheetT1.css">
            ...
            <div class="navTdata">
               ...
               <div class="navTsignin " id="navT-signin">
                <a href="login.jsp">
                    ...
                    <button >Login<i class='bx bxs-log-out-circle' ></i></button></a>
                </div>
    ...
    <main class="mainT" id="mainT">
        ...
        <section class="sectionT container " id="home">
            <div class="swiper mySwiper1">
                ...
                <div class="swiper-slide"><img src="s_images/event1.jpg" alt="img1">
                <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="s_images/event 2.jpg" alt="img2">
                    <div class="inputone" >
                        <h1>Socials</h1>
                        <p>
                ...
                <div class="swiper-slide"><img src="s_images/event3.jpg" alt="img3">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="s_images/event4.jpg" alt="img4">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="s_images/event5.jpg" alt="img5">
                    <div class="inputone" >
                ...
                <div class="swiper-slide"><img src="s_images/event6.jpg" alt="img6">
                    <div class="inputone" >
                        <h1>Dinner Dance</h1>
                        <p>
                            You can Recieve the Hotels For Your Specail day 
                ...
                <div class="swiper-slide"><img src="s_images/event7.jpg" alt="img7">
                    <div class="inputone" >
        ...
        <section class="sectionT container sectionTheight" id="packages">
            ...
            <div class="swiper mySwiper2">
                ...
                <div class="inputone1" ><img src="s_images/event4.jpg" alt="img4">
        ...
        <section class="sectionT container " id="About">
            ...
            <div class="swiper">
                <div class="about-containt">
                   <div class="about-img">
                    <img src="s_images/event4.jpg" alt="img4">
        ...
        <section class="sectionT container sectionTheight" id="gallery">
            ...
            <div class="swiper mySwiper3">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                    <img src="s_images/event5.jpg" alt="img5">
                </div>
                <div class="swiper-slide">
                    <img src="s_images/event5.jpg" alt="img5">
                </div>
